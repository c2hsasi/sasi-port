  ...
  return (
    <div className="lg:mx-12 mx-4 my-32" id="portfolio">
      <div className="mb-20 flex flex-col sm:flex-row md:items-center justify-between gap-5">
        ...
        <button className="py-3 px-4 text-white rounded-md bg-dribble w-2/3 sm:w-auto">
          <svg
        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className="p-8">
              ...
              <button
                className="px-5 py-2 mr-10 bg-green-500 border border-primary text-bold rounded hover:bg-primary hover:text-white transition-all duration-300 "
                onClick={() => {
              ...
              <button
                className="px-3 py-2 bg-red-400 border border-primary text-bold rounded hover:bg-primary hover:text-white transition-all duration-300 "
                onClick={() => {
